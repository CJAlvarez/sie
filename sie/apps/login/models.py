...
class Catestudia(models.Model):
    estdudia_id = models.AutoField(primary_key=True)  # Field name made lowercase.
    estudia = models.CharField(max_length=50, blank=True, null=True)  # Field name made lowercase.
    lasteditdate = models.DateTimeField(blank=True, null=True)  # Field name made lowercase.
    creationdate = models.DateTimeField(db_column='CreationDate', blank=True, null=True)  # Field name made lowercase.
...
class Catgradoalcanzado(models.Model):
    grado_id = models.AutoField(primary_key=True)  # Field name made lowercase.
    grado = models.CharField(max_length=50, blank=True, null=True)  # Field name made lowercase.
    lasteditdate = models.DateTimeField(blank=True, null=True)  # Field name made lowercase.
    creationdate = models.DateTimeField(db_column='CreationDate', blank=True, null=True)  # Field name made lowercase.
...
class Catdiscapacidades(models.Model):
    discapacidad_id = models.AutoField(primary_key=True)  # Field name made lowercase.
    discapacidad = models.CharField(max_length=50, blank=True, null=True)  # Field name made lowercase.
    lasteditdate = models.DateTimeField(blank=True, null=True)  # Field name made lowercase.
    creationdate = models.DateTimeField(db_column='CreationDate', blank=True, null=True)  # Field name made lowercase.
...
class Cateducadores(models.Model):
    ...
    ed_gradoalcanzado = models.CharField(models.DO_NOTHING, db_column='gradoalcanzado_Id', max_length=200,blank=True, null=True)  # Field name made lowercase.
...
class ProcesoEducativo(models.Model):
    ...
    dep = models.ForeignKey(Catdepartamentos, models.DO_NOTHING, db_column='Dep_Id', blank=True, null=True)  # Field name made lowercase.
    mun = models.ForeignKey(Catmunicipios, models.DO_NOTHING, db_column='Mun_id', blank=True, null=True)  # Field name made lowercase.
    Donde_desarrollara_proceso = models.ForeignKey(Cattipossedes, models.DO_NOTHING, db_column='catsede_id', blank=True,null=True)  # Field name made lowercase.
    ...
    sectoreconomico = models.ForeignKey(Catsectoreseconomicos, models.DO_NOTHING, db_column='catsectores_id', blank=True,null=True)  # Field name made lowercase.
...
class Personas(models.Model):
     id_personas=models.AutoField(db_column='id_personas' ,primary_key=True, unique=True)
     clavececap = models.CharField(db_column='ClaveCecap', max_length=10, blank=True, null=True)  # Field name made lowercase.
...
#     numero_de_casa = models.CharField(db_column='Numero_de_Casa', max_length=10, blank=True, null=True)  # Field name made lowercase.
     dep = models.ForeignKey(Catdepartamentos, models.DO_NOTHING, db_column='Dep_Id', blank=True, null=True)  # Field name made lowercase.
     mun = models.ForeignKey(Catmunicipios, models.DO_NOTHING, db_column='Mun_id', blank=True, null=True)  # Field name made lowercase.
     aldea = models.ForeignKey(Cataldeas, models.DO_NOTHING, db_column='Al_id', blank=True, null=True)  # Field name made lowercase.
     caserio = models.ForeignKey(Catcaserios, models.DO_NOTHING, db_column='Ca_id', blank=True, null=True)  # Field name made lowercase.
     ...
     ec = models.ForeignKey(Catestadocivil, models.DO_NOTHING, db_column='EC_Id', blank=True, null=True)  # Field name made lowercase.
     esta_estudiando = models.ForeignKey(Catestudia, models.DO_NOTHING, db_column='Catestudia_id', blank=True, null=True)  # Field name made lowercase.
     tiene_alguna_discapacidad = models.ForeignKey(Catdiscapacidades, models.DO_NOTHING, db_column='Catdiscapacidades_id', blank=True, null=True)  # Field name made lowercase.
...
class Personasporprocesoeducativo(models.Model):
     ...
     egreso = models.CharField(db_column='egreso', max_length=50, blank=True, null=True, default="Null")  # Field name made lowercase.
     lasteditdate = models.DateTimeField(db_column='LastEditDate', blank=True, null=True)  # Field name made lowercase.
     creationdate = models.DateTimeField(db_column='CreationDate', blank=True, null=True)  # Field name made lowercase.
...
class Modulos(models.Model):
    ...
    horasteoricas16 = models.CharField(db_column='horasteoricas16', max_length=100, blank=True,
                                      null=True)  # Field  lowercase. Field renamed to remove unsuitable characters.
    horaspracticas16 = models.CharField(db_column='horaspracticas16', max_length=100, blank=True,
                                       null=True)  # Field  lowercase. Field renamed to remove unsuitable characters.
...
class Evaluaciones(models.Model):
            ...
            #notateorica30 = models.FloatField(db_column='NotaTeorica30',blank=True,null=True)
